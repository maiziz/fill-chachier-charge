...
import { Send, Bot, User, Mic, Image as ImageIcon, Square, X, Paperclip, FileText, Settings2 } from 'lucide-react';
...
export function ChatSidebar({ fields, messages, onSendMessage, isProcessing, selectedModel, onModelChange }: ChatSidebarProps) {
    ...
    <div className="w-96 bg-white border-l border-stone-200 flex flex-col h-full shadow-lg z-10">
      <div className="p-4 border-b border-stone-100 bg-stone-50/50 flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-stone-500 mt-1">I can help you fill out this document.</p>
        </div>
